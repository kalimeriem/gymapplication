      ...
      <Stack.Screen options={{headerShown: false}} />
        <View style={loginSignup.container}>
          ...
          <View style={loginSignup.title}>
            <Text style={loginSignup.titleText}>What is your goal?</Text>
          </View>
          ...
          <View style={[loginSignup.card, loginSignup.SmallPagesCard, loginSignup.optionPage]}>
						...
						<View style={[loginSignup.moveToPage, loginSignup.optionPagePadding]}>
							...
							<TouchableOpacity style={[loginSignup.RedLoginSignupButton, loginSignup.moveToPageButton]}>
								<Text style={loginSignup.RedLoginSignupButtonText}>Submit</Text>
							</TouchableOpacity>
						</View>
